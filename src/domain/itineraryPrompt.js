...
- When an image is provided (with or without text), you MUST still return the JSON object.
- Do not describe the image, do not include reasoning or analysis, and do not return blank content.
- If no events can be extracted from the image, return {"events": []} only.
